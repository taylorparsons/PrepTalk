...
# ExampleCo app compartmentalization plan (general chat + new agent teams)

## Goals
- Keep the current general chat feature stable while enabling new agent teams with their own parameter sets at the organization.
