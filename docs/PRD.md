...
- Stage gating: hide or collapse containers without relevant content per stage (e.g., collapse Candidate Setup after interview starts; hide questions/insights/transcript/score/controls panels until content exists). (Sources: CR-20260203-1138, CR-20260203-1146; D-20260203-1138)
